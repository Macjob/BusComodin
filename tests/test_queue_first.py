...
def test_queue_first_is_deterministic_and_reuses_three_reinforcements() -> None:
    ...
    assert first["metadata"]["reinforcement_assignments"] > 3
    assert first["metadata"]["reinforcement_reposition_minutes"] > 0
